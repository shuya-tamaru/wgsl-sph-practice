  ...
  private init() {
    ...
    this.bindGroup = this.device.createBindGroup({
      ...
      entries: [
        ...
        { binding: 2, resource: { buffer: this.particles.densityBuffer } },
        { binding: 3, resource: { buffer: this.particles.pressureBuffer } },
        { binding: 4, resource: { buffer: this.particles.sphParamsBuffer } },
