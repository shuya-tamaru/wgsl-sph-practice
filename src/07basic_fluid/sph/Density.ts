...
import densityShader from "../shaders/densityShader.wgsl";
  ...
  private init() {
    ...
    this.bindGroup = this.device.createBindGroup({
      ...
      entries: [
        ...
        { binding: 1, resource: this.particles.densityBuffer },
        { binding: 2, resource: this.particles.particleParamsBuffer },
      ],
    });
  }
